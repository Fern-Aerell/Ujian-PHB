...
<template>
    <!-- SIDEBAR -->
    <div class="flex flex-col p-[30px] bg-[#FFFFFF] w-[350px] justify-between overflow-y-auto h-full">
        <!-- TOP -->
        ...
        <div class="flex flex-col gap-[10px] items-start">
            <slot name="end"/>
            <div class="flex justify-center items-center py-[10px] h-full w-full">
                <CreditsText />
            </div>
        </div>
    </div>
