...
import noImageAvailable from '../../assets/images/no_image_available.webp';
import { ref } from 'vue';
...
const image = ref<string>(props.src ?? noImageAvailable);
...
<template>
    <button type="button" @click="() => open()" title="Klik untuk mengganti gambar" class="w-fit relative group">
        <img :src="image" alt="gambar" :class="`${props.imgClass} transition-all duration-300 group-hover:brightness-75`">
        <div
